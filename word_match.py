...
class Match:
    ...
    # запрос на извлечение всех существующих записей из базы в алф. порядке
    def get_words(self):
    ...
    # обработка клика по словам в правой колонке
    def callback_right(self, event1):
        ...
        # если выбранное слово является переводом, удаляем и оригинал, и значение
        if click == self.trans:
    ...
    def run_edit(self):
        os.system('python3 edit_dictionary.py')
...
if __name__ == '__main__':
    window = Tk()
    window.geometry('360x255+350+200')
